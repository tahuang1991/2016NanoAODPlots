...
def writeintoworkspace_2D(masslist,inputdir, prefix_out, outdir):
...
outdir = prefix_out+"_limits_20180804/"
method = "Asymptotic"
masslist = [260, 270, 300, 350, 400, 450, 500, 550, 600, 650, 750, 800, 900]
masslist = [750]
#masslist = [400]
#writeintoworkspace_1D(masslist,inputdir, prefix_out, outdir)
#inputdir = "HHbbWW_20180802_NNoutputVsHME_MjjCR/"
inputdir = "HHbbWW_20180802_NNoutputVsHME_MjjCR_M750_800_900/"
#outdir = prefix_out+"_2Dlimits_20180804/"
outdir = prefix_out+"_2Dlimits_20180804_M750_800_900/"
