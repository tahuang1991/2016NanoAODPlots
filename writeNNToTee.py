...
def writeNNToTree(input_file, weight, modellist, modelLUT, sampletype, masslist, outFile):
    ...
    for sys in ["jjbtag_heavy","jjbtag_light","event_pu_weigh","event_pdf_weight"]:
        for plottype in ["up","down"]:
...
filepath = "/Users/taohuang/Documents/DiHiggs/20180316_NanoAOD/20180402_10k_TTbar_DoubleMu_HHbbWW/"
...
output_suffix = '2018-04-03_addNN'
...
def makeBackgroundshist(filefolder, masspoints, variable, nbins, xtitle, outdir):
    ...
    for mass in masspoints:
        ...
        file_s = os.path.join(filefolder, "GluGluToRadionToHHTo2B2VTo2L2Nu_M-%d_narrow_13TeV-madgraph-v2_Friend.root"%mass)
        backgrounddict = {}
        """
